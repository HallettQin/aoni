...
<!--[if IE 7]> <html class="no-js lt-ie9 lt-ie8" lang="en"> 
  ...
  <head>
    ...
    <meta charset="UTF-8">
    <title>避孕套使用方法|避孕方法|避孕套知识|成人知识|成人展|奥妮不仅仅是吉尼斯最薄</title>
    <meta name="keywords" content="避孕套哪个牌子好,避孕方法,安全期避孕,奥妮避孕套好吗,奥妮避孕套怎么样,女用避孕套,避孕套知识" />
    <meta name="description" content="奥妮新闻频道提供最新最全的避孕套资讯，安全套新闻,成人知识,避孕套怎么挑？避孕知识,避孕方法与成人用品展等避孕套信息" />
    ...
    <!-- Modernizr -->
    <script src="{$siteurl}/templets/{$templets->directory}/slider/modernizr.js"></script>
...
<body>
        ...
        <div class="col-md-10 col-sm-10 col-xs-12" >
          <div class="navbar-collapse collapse menu">       
            <ul class="nav navbar-nav navbar-right" >
              ...
              <li class="dropdown">  
                <a class="dropdown-toggle" data-toggle="dropdown" title="精英系列">精英产品<b class="caret"></b></a>  
  ...
  <!--第一-->
  <div class="more none1">
        <li><a href="{$siteurl}/category/about"><img src="{$siteurl}/templets/{$templets->directory}/images/nav1.jpg" /></a></li>
        <li><a href="{$siteurl}/category/news"><img src="{$siteurl}/templets/{$templets->directory}/images/nav2.jpg" /></a></li>
        <li><a href="{$siteurl}/category/knowledge"><img src="{$siteurl}/templets/{$templets->directory}/images/nav3.jpg" /></a></li>
        <li><a href="{$siteurl}/category/exhibition"><img src="{$siteurl}/templets/{$templets->directory}/images/nav4.jpg" /></a></li>
        </div>
  
  <div class="container" style="margin-top:100px;">
      <div class="row list_b">
         <div class="new_x"><a href="{$siteurl}">首页</a>  >  新闻  >  奥妮新闻
           </div>
           </div>
   </div>
...
{if ($total > 0)}
   ...
   <div class="row diant">
           <a href="{formaturl siteurl=$siteurl type="article" name=$artinfo->filename}" target="_blank">
           <div class="col-md-2 col-sm-2 col-xs-4 none1" >
            <img src="{assign var="artinfoa" value=$metadata->GetMetaName("article","地址",$artinfo->aid)}{$artinfoa->metavalue}" style=" width:150px; height:100px; padding:0 9px;"/>
            </div>
      <div class="col-md-10 col-sm-10 col-xs-12" ><h4>{$artinfo->title|truncate:66:"...":true}<span style=" position:absolute; right:10px; font-size:12px; color:#666; font-weight:200; margin:0 8px;" class="nones">{$artinfo->adddate}</span></h4>
        <span style=" font-size:12px;">{$artinfo->seodescription|strip_tags|truncate:98:"...":true}</a></span>
       </div>
       </div>
...
{assign var="prepage" value="`$curpage-1`"}
      ...
      <ul class="pagination">
                ...
                <ul class="shangxia">
                  {if ($curpage > 1)}
                  <li class="one"><a href="{formaturl type="category" siteurl=$siteurl name=$category->filename page=$prepage}"><img src="{$siteurl}/templets/{$templets->directory}/images/n001.png" /></a></li>
                  <!--<li><a href="#">1</a></li>
                  <li><a href="#">2</a></li>-->
                  {/if}
				  {if ($curpage > 0) && ($curpage < $totalpage)}
                  <li class="one"><a href="{formaturl type="category" siteurl=$siteurl name=$category->filename page=$nextpage}"><img src="{$siteurl}/templets/{$templets->directory}/images/n002.png" /></a></li>
             	 {/if}  
                </ul>
                 {else}
				该分类下暂时没有内容
...
<!--固定标题-->
 <div id="mobile-footer" class="none2">
        <a href="{$siteurl}/category/about">奥妮新闻</a>
        <a href="{$siteurl}/category/news">安全套趣闻</a>
        <a href="{$siteurl}/category/knowledge">成人知识</a>
        <a href="{$siteurl}/category/exhibition">医药成人展</a>
    </div>
    ...
    <div class="container">
            <div class="row">
             ...
             <div class="col-xs-12 col-ms-6 col-sm-4">
                   <ul>
                <h4>产品系列</h4>
                <li><a href="{$siteurl}/001.html" target="_blank">零距超薄001</a></li>
                ...
                <h4>新闻中心</h4>
                  <li><a href="{$siteurl}/category.php?name=about" target="_blank">浏览我们的新闻中心</a></li>
            </ul>
                 </div>
...
<script src="{$siteurl}/templets/{$templets->directory}/js/top.js"></script>
</html>
