...
if($action=='save')
{
	...
	$sql = "UPDATE yiqi_article SET title = '$articletitle',cid='$articlecategory' ,uid='$adminuserinfo->uid',seotitle='$articleseotitle' ,seokeywords='$articlekeywords' ,seodescription='$articledescription',content='$articlecontent' ,adddate='$articleadddate', lasteditdate='$nowdate',filename='$articlefilename' ,templets='$articletemplets' WHERE aid = '$aid' limit 1";
